        ...
        def dfs(employee, has_discount):
            ...
            for child in adj_list[employee]:
                ...
                for (
                    spent,
                    prof,
                ) in buy_current.items():  # Do something, but the current stock
                ...
                buy_current = new_buy  # all possible combinations of picking children

                new_skip = {}
                for (
                    spent,
                    prof,
                ) in skip_current.items():  # Do nothing, skip the current stock
            ...
            result = (
                {}
            )  # Merge the results of doing something and doing nothing at node employee
